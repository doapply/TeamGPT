<p align="center">
  <img src="https://raw.githubusercontent.com/doapply/TeamGPT/main/public/banner.png?token=GHSAT0AAAAAAB7JND3U3VGGF3UYYHGYO4RAZBSDJAQ" height="300"/>
</p>
<p align="center">
...
<p align="center">
<a href="https://TeamGPT.doapply.ai">🔗 Short link</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
...
<p align="center">
<a href="https://github.com/sponsors/doapply">👉 Click here</a> to support the project 
</p>

---

TeamGPT allows you to configure and deploy Autonomous AI agents.
...
The easiest way to run TeamGPT locally is by using docker.
...
If you wish to develop TeamGPT locally, the easiest way is to
...
- [Click here](https://github.com/doapply/TeamGPT/fork).

2. Clone the repository:

```bash
git clone git@github.com:YOU_USER/TeamGPT.git
```
...
> 🚧 The environment variables must match the following [schema](https://github.com/doapply/TeamGPT/blob/main/src/env/schema.mjs).
